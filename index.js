...
// Make sure to console log all 3 titles (after you get the data retrieve the nested values) 
  let requestUrl = "https://api.artic.edu/api/v1/artworks/search?q=dog&limit=3"
...
async function searchArtworks(name,size){
  let requestUrl = "https://api.artic.edu/api/v1/artworks/search?q="+name+"&limit="+size
  let response = await fetch(requestUrl)
  let data = await response.json()
  console.log(data)
  return data
